...
public class Teclado
{
	...
	// Leemos un número decimal float
	{
		float numero = 0.0f;
		boolean correcto = false;
	...
	// Leemos un número decimal double
	{
		double numero = 0.0;
		boolean correcto = false;
	...
	// Leemos un carácter  -  http://stackoverflow.com/questions/13942701/take-a-char-input-from-the-scanner
	{
		char caracter = 0;
		boolean correcto = false;
